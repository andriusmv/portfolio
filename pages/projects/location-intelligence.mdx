...
You can find the project repo here: [GitHub repo](https://github.com/andriusmv/4toplano) and the live demo here: [4toplano](https://4toplano.vercel.app/) (demo version, final result requires auth)

User auth was implemented with Supabase, which is a PostgreSQL instance on top of AWS.

<br />
<br />
<Image src="/Location.png" width={1200} height={825} />
<br />
<Image src="/controls.png" width={900} height={478} />
<br />
<Image src="/dashboard.png" width={900} height={506} />
